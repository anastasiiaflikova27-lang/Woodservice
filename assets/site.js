...
const projects=[
 ...
 {id:'white-mirror-wardrobe',cat:'storage',title:'Встроенная система хранения с зеркальными фасадами',desc:'Один проект: шкафы под размер, зеркальные секции и внутреннее хранение для частного интерьера.',cover:img('work-groups/white-mirror-wardrobe/white-mirror-wardrobe-main.jpg'),gallery:[img('work-groups/white-mirror-wardrobe/white-mirror-wardrobe-main.jpg'),img('work-groups/white-mirror-wardrobe/white-mirror-wardrobe-corridor.jpg'),img('work-groups/white-mirror-wardrobe/white-mirror-wardrobe-side.jpg'),img('work-groups/white-mirror-wardrobe/white-mirror-wardrobe-inside.jpg'),img('work-groups/white-mirror-wardrobe/white-mirror-wardrobe-shoe-rack.jpg')]},
